...
require File.expand_path('lib/billy/version', __dir__)
...
Gem::Specification.new do |gem|
  ...
  gem.required_ruby_version = '>= 3.3.10'
  ...
  gem.add_development_dependency 'rubocop-capybara'
  gem.add_development_dependency 'rubocop-rspec'
  gem.add_development_dependency 'selenium-webdriver', '>= 4.0'
  gem.add_development_dependency 'thin'
  gem.add_development_dependency 'watir', '~> 7.0'
end
